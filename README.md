    ...
    services:
      backup:
        ...
        environment:
          ...
          - PUID=1000 # Optional, backup becomes owned by the specified PUID, defaults to 0
          - PGID=1000 # Optional, backup becomes owned by the specified PGID, defaults to 0
        volumes:
...
As of 1.4.0 the image is based off of Debian Trixie instead of Debian Bookworm. Backup script always runs as root but sets ownership of backup to PUID:PGID